      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-lg border p-6 space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? <><span className="animate-spin">⟳</span> Signing in...</> : <><LogIn className="w-4 h-4" /> Sign In</>}
            </button>
          </form>
        ...
        <p className="text-center text-sm text-gray-500">
          ...
          <Link href="/auth/register" className="text-blue-500 hover:underline font-medium">Register</Link>
        </p>
      </div>
    </main>
  )
